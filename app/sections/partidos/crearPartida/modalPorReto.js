'use strict';
angular.module('app')
.controller('ModalCrearPartidaPorRetoController', ['$uibModal', '$uibModalInstance', '$scope', '$timeout', 'wdkFunctions', function($uibModal, $uibModalInstance, $scope, $timeout, wdkFunctions){
